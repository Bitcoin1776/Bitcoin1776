 ...
 * DynamicUsage(vector<vector<int> >)
 *  will compute the memory used for the vector<int>'s, but not for the ints
 * inside.
 *  This is for efficiency reasons, as these functions are intended to be fast.
 * If
 *  application data structures require more accurate inner accounting, they
 * should
 *  iterate themselves, or use more efficient caching + updating on
 * modification.
 */

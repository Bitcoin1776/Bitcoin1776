...
#ifndef JFKBITCOIN1776_CONSENSUS_VALIDATION_H
#define JFKBITCOIN1776_CONSENSUS_VALIDATION_H
...
public:
  ...
  bool DoS(int level, bool ret = false, unsigned int chRejectCodeIn = 0,
           const std::string &strRejectReasonIn = "", bool corruptionIn = false,
...
static inline int64_t GetTransactionWeight(const CTransaction &tx) {
  return ::GetSerializeSize(tx, SER_NETWORK,
                            PROTOCOL_VERSION |
...
static inline int64_t GetBlockWeight(const CBlock &block) {
  ...
  return ::GetSerializeSize(block, SER_NETWORK,
                            PROTOCOL_VERSION |
                                SERIALIZE_TRANSACTION_NO_WITNESS) *
             (WITNESS_SCALE_FACTOR - 1) +
...
#endif // JFKBITCOIN1776_CONSENSUS_VALIDATION_H

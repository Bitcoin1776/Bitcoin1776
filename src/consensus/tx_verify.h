...
#ifndef JFKBITCOIN1776_CONSENSUS_TX_VERIFY_H
#define JFKBITCOIN1776_CONSENSUS_TX_VERIFY_H
...
/** Auxiliary functions for transaction validation (ideally should not be
 * exposed) */
 ...
 * in a block.
 * Consensus critical. Takes as input a list of heights at which tx's inputs (in
 * order) confirmed.
 */
bool SequenceLocks(const CTransaction &tx, int flags,
                   std::vector<int> *prevHeights, const CBlockIndex &block);

#endif // JFKBITCOIN1776_CONSENSUS_TX_VERIFY_H

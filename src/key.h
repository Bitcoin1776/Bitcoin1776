...
#ifndef JFKBITCOIN1776_KEY_H
#define JFKBITCOIN1776_KEY_H
...
public:
  ...
  //! Check whether the public key corresponding to this private key is (to be)
  //! compressed.
  ...
  /**
   * Create a compact signature (65 bytes), which allows reconstructing the used
   * public key.

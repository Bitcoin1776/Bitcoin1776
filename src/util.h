 ...
 */
#ifndef JFKBITCOIN1776_UTIL_H
#define JFKBITCOIN1776_UTIL_H
...
extern const char *const JFKBITCOIN1776_CONF_FILENAME;
extern const char *const JFKBITCOIN1776_PID_FILENAME;
 ...
 * If no translation slot is registered, nothing is returned, and simply return
 * the input.
 */
...
template <typename Callable> void TraceThread(const char *name, Callable func) {
  std::string s = strprintf("jfkbitcoin1776-%s", name);

...
#ifndef JFKBITCOIN1776_VALIDATIONINTERFACE_H
#define JFKBITCOIN1776_VALIDATIONINTERFACE_H
...
public:
  /** Register a CScheduler to give callbacks which should run in the background
...
#endif // JFKBITCOIN1776_VALIDATIONINTERFACE_H

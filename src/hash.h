...
#ifndef JFKBITCOIN1776_HASH_H
#define JFKBITCOIN1776_HASH_H
...
/** A hasher class for JFKBitcoin1776's 256-bit hash (double SHA-256). */
class CHash256 {
private:
  CSHA256 sha;
...
/** A hasher class for JFKBitcoin1776's 160-bit hash (SHA-256 + RIPEMD-160). */
class CHash160 {
private:
  CSHA256 sha;

    ...
    if(role == Qt::DisplayRole || role == Qt::EditRole)
    {
        ...
        case Amount:
            if (rec->recipient.amount == 0 && role == Qt::DisplayRole)
                ...
                return JFKBitcoin1776Units::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount, false, JFKBitcoin1776Units::separatorNever);
            else
                return JFKBitcoin1776Units::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount);
        }
    }
...
{
    return (this->walletModel->getOptionsModel() != nullptr) ? tr("Requested") + " ("+JFKBitcoin1776Units::name(this->walletModel->getOptionsModel()->getDisplayUnit()) + ")" : "";
}

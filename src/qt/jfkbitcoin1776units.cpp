...
QString JFKBitcoin1776Units::description(int unit) {
  switch (unit) {
  case JFK:
    return QString("JFKBitcoin1776s");
  case mJFK:
    return QString("Milli-JFKBitcoin1776s (1 / 1" THIN_SP_UTF8 "000)");
  case uJFK:
    return QString("Micro-JFKBitcoin1776s (1 / 1" THIN_SP_UTF8
...
QString JFKBitcoin1776Units::format(int unit, const CAmount &nIn, bool fPlus,
...
QString JFKBitcoin1776Units::formatWithUnit(int unit, const CAmount &amount,
                                            bool plussign,
                                            SeparatorStyle separators) {
  return format(unit, amount, plussign, separators) + QString(" ") + name(unit);
}

QString JFKBitcoin1776Units::formatHtmlWithUnit(int unit, const CAmount &amount,
                                                bool plussign,
                                                SeparatorStyle separators) {
...
bool JFKBitcoin1776Units::parse(int unit, const QString &value,
                                CAmount *val_out) {
...
CAmount JFKBitcoin1776Units::maxMoney() { return MAX_MONEY; }

...
static const char UNUSED *jfkbitcoin1776_strings[] = {
    ...
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ...
                      "estimation has insufficient "
                      "data (default: %s)"),
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ""
                      "Accept relayed transactions received from whitelisted "
                      "peers even when not "
    ...
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ...
                      "[host]:port notation for "
                      "IPv6"),
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ""
                      "Bind to given address and whitelist peers connecting to "
                      "it. Use [host]:port "
                      "notation for IPv6"),
    QT_TRANSLATE_NOOP(
        "jfkbitcoin1776-core",
        ...
        "overrides -"
        "rpcport. Use [host]:port notation for IPv6. This option can be "
        "specified "
    ...
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ""
                      "Do not keep transactions in the mempool longer than <n> "
                      "hours (default: %u)"),
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ""
    ...
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ""
                      "Error loading %s: You can't enable HD on an already "
    ...
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ""
                      "Exclude debugging information for a category. Can be "
                      "used in conjunction "
                      "with -debug=1 to output debug logs for all categories "
                      "except one or more "
    ...
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ""
                      "Execute command when the best block changes (%s in cmd "
                      "is replaced by block "
                      "hash)"),
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ""
                      "Extra transactions to keep in memory for compact block "
                      "reconstructions "
                      "(default: %u)"),
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ""
    ...
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ""
                      "Force relay of transactions from whitelisted peers even "
                      "if they violate "
                      "local relay policy (default: %d)"),
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ""
                      "How thorough the block verification of -checkblocks is "
                      "(0-4, default: %u)"),
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ""
    ...
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ...
                      "transaction or raw "
                      "transaction; setting this too low may abort large "
                      "transactions (default: %s)"),
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ""
                      "Number of seconds to keep misbehaving peers from "
                      "reconnecting (default: %u)"),
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ""
                      "Output debugging information (default: %u, supplying "
                      "<category> is optional)"),
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ""
                      "Please check that your computer's date and time are "
                      "correct! If your clock "
    ...
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ""
                      "Prune configured below the minimum of %d MiB.  Please "
                      "use a higher number."),
    QT_TRANSLATE_NOOP(
        "jfkbitcoin1776-core",
        ""
    ...
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ""
                      "Randomize credentials for every proxy connection. This "
                      "enables Tor stream "
                      "isolation (default: %u)"),
    QT_TRANSLATE_NOOP(
        "jfkbitcoin1776-core",
    ...
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ""
                      "Set lowest fee rate (in %s/kB) for transactions to be "
                      "included in block "
                      "creation. (default: %s)"),
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ""
    ...
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ""
                      "The block database contains a block which appears to be "
                      "from the future. "
                      "This may be due to your computer's date and time being "
                      "set incorrectly. Only "
                      "rebuild the block database if you are sure that your "
                      "computer's date and "
                      "time are correct"),
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ""
                      "The fee rate (in %s/kB) that indicates your tolerance "
                      "for discarding change "
                      "by adding it to the fee (default: %s). Note: An output "
                      "is discarded if it is "
                      "dust at this rate, but we will always discard up to the "
                      "dust relay fee and a "
                      "discard fee above that is limited by the fee estimate "
                      "for the longest target"),
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ""
                      "The transaction amount is too small to send after the "
    ...
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ""
                      "This is the transaction fee you may discard if change "
                      "is smaller than dust "
                      "at this level"),
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ""
                      "This is the transaction fee you may pay when fee "
    ...
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ""
                      "Use separate SOCKS5 proxy to reach peers via Tor hidden "
                      "services (default: "
                      "%s)"),
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ""
    ...
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ...
                      "Some miners appear to "
                      "be experiencing issues."),
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ""
                      "Warning: Unknown block versions being mined! It's "
                      "possible unknown rules are "
                      "in effect"),
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ""
    ...
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
                      ...
                      "relayed, even if they are already in the mempool, "
    ...
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core", "Accept connections from outside "
                                             "(default: 1 if no -proxy or "
                                             "-connect)"),
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
    ...
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core", "Error loading %s: You can't "
                                             "disable HD on an already "
                                             "existing HD wallet"),
    ...
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core", "Listen for JSON-RPC connections "
                                             "on <port> (default: %u or "
                                             "testnet: %u)"),
    QT_TRANSLATE_NOOP(
        "jfkbitcoin1776-core",
    ...
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core", "Reducing -maxconnections from %d "
                                             "to %d, because of system "
                                             "limitations."),
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core",
    ...
    QT_TRANSLATE_NOOP("jfkbitcoin1776-core", "Unable to bind to %s on this "
                                             "computer. %s is probably already "
                                             "running."),
    QT_TRANSLATE_NOOP(
        "jfkbitcoin1776-core",

  ...
  case Encrypt: // Ask passphrase x2
    ui->warningLabel->setText(
        tr("Enter the new passphrase to the wallet.<br/>Please use a "
           "passphrase of <b>ten or more random characters</b>, or <b>eight or "
           "more words</b>."));
    ui->passLabel1->hide();
    ui->passEdit1->hide();
...
void AskPassphraseDialog::accept() {
  ...
  case Encrypt: {
    ...
    QMessageBox::StandardButton retval = QMessageBox::question(
        ...
        tr("Warning: If you encrypt your wallet and lose your passphrase, you "
           "will <b>LOSE ALL OF YOUR JFKBITCOIN1776S</b>!") +
      ...
      if (newpass1 == newpass2) {
        if (model->setWalletEncrypted(true, newpass1)) {
          QMessageBox::warning(
              ...
              "<qt>" +
                  tr("%1 will close now to finish the encryption process. "
                     ...
                     "protect "
                     "your jfkbitcoin1776s from being stolen by malware "
                     "infecting your computer.")
                      .arg(tr(PACKAGE_NAME)) +
                  "<br><br><b>" + tr("IMPORTANT: Any previous backups you have "
                                     ...
                                     "of the unencrypted wallet file "
          ...
          QMessageBox::critical(
              ...
              tr("Wallet encryption failed due to an internal error. Your "
  ...
  case Unlock:
    if (!model->setWalletLocked(false, oldpass)) {
      QMessageBox::critical(this, tr("Wallet unlock failed"),
                            tr("The passphrase entered for the wallet "
...
void AskPassphraseDialog::textChanged() {
  ...
  case Encrypt: // New passphrase x2
    acceptable =
        !ui->passEdit2->text().isEmpty() && !ui->passEdit3->text().isEmpty();
    break;

...
AddressBookPage::AddressBookPage(const PlatformStyle *platformStyle, Mode _mode,
    ...
    : QDialog(parent), ui(new Ui::AddressBookPage), model(0), mode(_mode),
      tab(_tab) {
  ui->setupUi(this);
  ...
  switch (tab) {
  case SendingTab:
    ui->labelExplanation->setText(tr(
        "These are your JFKBitcoin1776 addresses for sending payments. Always "
        "check the amount and the receiving address before sending coins."));
    ui->deleteAddress->setVisible(true);
    break;
  case ReceivingTab:
    ui->labelExplanation->setText(tr(
        "These are your JFKBitcoin1776 addresses for receiving payments. It is "
...
void AddressBookPage::on_exportButton_clicked() {
  ...
  if (!writer.write()) {
    QMessageBox::critical(this, tr("Exporting Failed"),
                          tr("There was an error trying to save the address "
                             "list to %1. Please try again.")
                              .arg(filename));
  }
}

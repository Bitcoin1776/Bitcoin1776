...
#ifndef JFKBITCOIN1776_QT_NOTIFICATOR_H
#define JFKBITCOIN1776_QT_NOTIFICATOR_H
...
public Q_SLOTS:
  /** Show notification message.
     ...
     @param[in] millisTimeout notification timeout in milliseconds (defaults to
     10 seconds)
...
private:
  ...
  void notifySystray(Class cls, const QString &title, const QString &text,
                     const QIcon &icon, int millisTimeout);
#ifdef Q_OS_MAC
  void notifyGrowl(Class cls, const QString &title, const QString &text,
                   const QIcon &icon);
...
#endif // JFKBITCOIN1776_QT_NOTIFICATOR_H

...
void PaymentServerTests::paymentServerTests() {
  ...
  // Ensure the request is initialized, because network "main" is default, even
  // for
  ...
  // Payment request with amount overflow (amount is set to 21000001 JFK):
...
void RecipientCatcher::getRecipient(SendCoinsRecipient r) { recipient = r; }

...
#include "qt/jfkbitcoin1776amountfield.h"
...
uint256 SendCoins(CWallet &wallet, SendCoinsDialog &sendCoinsDialog,
                  const CJFKBitcoin1776Address &address, CAmount amount,
                  bool rbf) {
  ...
  entry->findChild<JFKBitcoin1776AmountField *>("payAmount")->setValue(amount);
...
//! Request context menu (call method that is public in qt5, but protected in
//! qt4).
...
void BumpFee(TransactionView &view, const uint256 &txid, bool expectDisabled,
             std::string expectError, bool cancel) {
...
//
//     src/qt/test/test_jfkbitcoin1776-qt -platform xcb      # Linux
//     src/qt/test/test_jfkbitcoin1776-qt -platform windows  # Windows
//     src/qt/test/test_jfkbitcoin1776-qt -platform cocoa    # macOS
void TestSendCoins() {
  ...
  uint256 txid1 =
      SendCoins(wallet, sendCoinsDialog, CJFKBitcoin1776Address(CKeyID()),
                5 * COIN, false /* rbf */);
  uint256 txid2 =
      SendCoins(wallet, sendCoinsDialog, CJFKBitcoin1776Address(CKeyID()),
                10 * COIN, true /* rbf */);
  ...
  BumpFee(transactionView, txid1, true /* expect disabled */,
          "not BIP 125 replaceable" /* expected error */, false /* cancel */);
  BumpFee(transactionView, txid2, false /* expect disabled */,
          {} /* expected error */, true /* cancel */);
  BumpFee(transactionView, txid2, false /* expect disabled */,
          {} /* expected error */, false /* cancel */);
  BumpFee(transactionView, txid2, true /* expect disabled */,
          "already bumped" /* expected error */, false /* cancel */);
...
void WalletTests::walletTests() { TestSendCoins(); }

...
#ifndef JFKBITCOIN1776_QT_WALLETVIEW_H
#define JFKBITCOIN1776_QT_WALLETVIEW_H
...
/*
  ...
  It communicates with both the client and the wallet models to give the user an
...
public:
  ...
  void setJFKBitcoin1776GUI(JFKBitcoin1776GUI *gui);
...
#endif // JFKBITCOIN1776_QT_WALLETVIEW_H

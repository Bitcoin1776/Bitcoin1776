...
#ifndef JFKBITCOIN1776_QT_ADDRESSTABLEMODEL_H
#define JFKBITCOIN1776_QT_ADDRESSTABLEMODEL_H
...
public:
  ...
  enum ColumnIndex {
    ...
    Address = 1 /**< JFKBitcoin1776 address */
  };
  ...
  enum EditStatus {
    ...
    WALLET_UNLOCK_FAILURE, /**< Wallet could not be unlocked to create new
                              receiving address */
    KEY_GENERATION_FAILURE /**< Generating a new public key for a receiving
                              address failed */
  };
...
#endif // JFKBITCOIN1776_QT_ADDRESSTABLEMODEL_H

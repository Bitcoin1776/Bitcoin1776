...
#ifndef JFKBITCOIN1776_MERKLEBLOCK_H
#define JFKBITCOIN1776_MERKLEBLOCK_H
...
protected:
  ...
  /** calculate the hash of a node in the merkle tree (at leaf level: the txid's
   * themselves) */
  ...
  /**
   * recursive function that traverses tree nodes, consuming the bits and hashes
   * produced by TraverseAndBuild.
...
public:
  ...
  /** Construct a partial merkle tree from a list of transaction ids, and a mask
...
public:
   ...
   * Note that this will call IsRelevantAndUpdate on the filter for each
   * transaction,
...
#endif // JFKBITCOIN1776_MERKLEBLOCK_H

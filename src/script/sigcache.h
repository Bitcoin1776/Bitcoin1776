...
#ifndef JFKBITCOIN1776_SCRIPT_SIGCACHE_H
#define JFKBITCOIN1776_SCRIPT_SIGCACHE_H
...
public:
  template <uint8_t hash_select> uint32_t operator()(const uint256 &key) const {
...
#endif // JFKBITCOIN1776_SCRIPT_SIGCACHE_H

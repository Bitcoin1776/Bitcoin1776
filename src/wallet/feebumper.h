...
#ifndef JFKBITCOIN1776_WALLET_FEEBUMPER_H
#define JFKBITCOIN1776_WALLET_FEEBUMPER_H
...
class CFeeBumper {
public:
  CFeeBumper(const CWallet *pWalletIn, const uint256 txidIn,
             const CCoinControl &coin_control, CAmount totalFee);
   ...
   * but, eventually sets vErrors if the tx could not be added to the mempool
   * (will try later)
...
#endif // JFKBITCOIN1776_WALLET_FEEBUMPER_H

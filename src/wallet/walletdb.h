...
#ifndef JFKBITCOIN1776_WALLET_WALLETDB_H
#define JFKBITCOIN1776_WALLET_WALLETDB_H
...
public:
  ...
  /* Recover convenience-function to bypass the key filter callback, called when
   * verify fails, recovers everything */
...
#endif // JFKBITCOIN1776_WALLET_WALLETDB_H

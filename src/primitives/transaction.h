...
#ifndef JFKBITCOIN1776_PRIMITIVES_TRANSACTION_H
#define JFKBITCOIN1776_PRIMITIVES_TRANSACTION_H
...
public:
   ...
   * method.
   *  Unserialize is not possible, since it would require overwriting const
   * fields. */
...
#endif // JFKBITCOIN1776_PRIMITIVES_TRANSACTION_H

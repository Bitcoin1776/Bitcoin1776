...
#ifndef JFKBITCOIN1776_SUPPORT_LOCKEDPOOL_H
#define JFKBITCOIN1776_SUPPORT_LOCKEDPOOL_H
...
public:
   ...
   *
   * The second argument is an optional callback when locking a newly allocated
   * arena failed.
   * If this callback is provided and returns false, the allocation fails (hard
   * fail), if
...
#endif // JFKBITCOIN1776_SUPPORT_LOCKEDPOOL_H

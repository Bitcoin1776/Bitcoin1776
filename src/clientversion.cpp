 ...
 * for both jfkbitcoin1776d and jfkbitcoin1776-core, to make it harder for
 * attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("JFKBitcoin1776");
 ...
 * (https://github.com/jfkbitcoin1776/bips/blob/master/bip-0014.mediawiki)
 */

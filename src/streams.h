...
#ifndef JFKBITCOIN1776_STREAMS_H
#define JFKBITCOIN1776_STREAMS_H
...
public:
   ...
   * start. The vector will initially
   *                    grow as necessary to  max(index, vec.size()). So to
   * append, use vec.size().
  */
...
#endif // JFKBITCOIN1776_STREAMS_H

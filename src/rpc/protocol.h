...
#ifndef JFKBITCOIN1776_RPCPROTOCOL_H
#define JFKBITCOIN1776_RPCPROTOCOL_H
...
//! JFKBitcoin1776 RPC error codes
enum RPCErrorCode {
  ...
  // RPC_INTERNAL_ERROR should only be used for genuine errors in
  // jfkbitcoin1776d
  ...
  //! P2P client errors
  RPC_CLIENT_NOT_CONNECTED = -9,        //!< JFKBitcoin1776 is not connected
  ...
  RPC_WALLET_WRONG_ENC_STATE = -15, //!< Command given in wrong wallet
                                    //!encryption state (encrypting an encrypted
                                    //!wallet etc.)
  RPC_WALLET_ENCRYPTION_FAILED = -16, //!< Failed to encrypt the wallet
  RPC_WALLET_ALREADY_UNLOCKED = -17,  //!< Wallet is already unlocked
  RPC_WALLET_NOT_FOUND = -18,         //!< Invalid wallet specified
  RPC_WALLET_NOT_SPECIFIED = -19, //!< No wallet specified (error when there are
...
#endif // JFKBITCOIN1776_RPCPROTOCOL_H

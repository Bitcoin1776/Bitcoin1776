...
#ifndef JFKBITCOIN1776_HTTPSERVER_H
#define JFKBITCOIN1776_HTTPSERVER_H
...
public:
  /** Create a new event.
   * deleteWhenTriggered deletes this event object after the event is triggered
   * (and the handler called)
...
#endif // JFKBITCOIN1776_HTTPSERVER_H

...
BOOST_AUTO_TEST_CASE(base58_keys_valid_parse)
{
    ...
    for (unsigned int idx = 0; idx < tests.size(); idx++) {
        ...
        if(isPrivkey)
        {
            ...
            // Note: CJFKBitcoin1776Secret::SetString tests isValid, whereas CJFKBitcoin1776Address does not!
...
BOOST_AUTO_TEST_CASE(base58_keys_valid_gen)
{
    ...
    for (unsigned int idx = 0; idx < tests.size(); idx++) {
        ...
        else
        {
            ...
            CJFKBitcoin1776Address addrOut;
    ...
    CJFKBitcoin1776Address dummyAddr;

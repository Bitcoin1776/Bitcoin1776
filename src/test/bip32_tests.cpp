...
TestVector test3 = TestVector("4b381541583be4423346c643850da4b320e46a87ae3d2a4e"
                              "6da11eba819cd4acba45d239319ac14f863b8d5ab5a0d0c6"
    ...
    0x80000000)("xpub68NZiKmJWnxxS6aaHmn81bvJeTESw724CRDs6HbuccFQN9Ku14VQrADWgq"
                "bhhTHBaohPX4CjNLf9fq9MYo6oDaPPLPxSb7gwQN3ih19Zm4Y",
                "xprv9uPDJpEQgRQfDcW7BkF7eTya6RPxXeJCqCJGHuCJ4GiRVLzkTXBAJMu2qa"
                "MWPrS7AANYqdq6vcBcBUdJCVVFceUvJFjaPdGZ2y9WACViL4L",
                0);
...
void RunTest(const TestVector &test) {
  ...
  for (const TestDerivation &derive : test.vDerive) {
    ...
    // Test private key
    CJFKBitcoin1776ExtKey b58key;
    b58key.SetKey(key);
    BOOST_CHECK(b58key.ToString() == derive.prv);

    CJFKBitcoin1776ExtKey b58keyDecodeCheck(derive.prv);
    CExtKey checkKey = b58keyDecodeCheck.GetKey();
    assert(checkKey == key); // ensure a base58 decoded key also matches

    // Test public key
    CJFKBitcoin1776ExtPubKey b58pubkey;
    b58pubkey.SetKey(pubkey);
    BOOST_CHECK(b58pubkey.ToString() == derive.pub);

    CJFKBitcoin1776ExtPubKey b58PubkeyDecodeCheck(derive.pub);
...
BOOST_AUTO_TEST_CASE(bip32_test3) { RunTest(test3); }

...
class VersionBitsTester {
  ...
  // The first one performs all checks, the second only 50%, the third only 25%,
  // etc...
...
BOOST_AUTO_TEST_CASE(versionbits_computeblockversion) {
  ...
  // Mine 2011 more blocks at the old time, and check that CBV isn't setting the
  // bit yet.
  ...
  // Now mine 5 more blocks at the start time -- MTP should not have passed yet,
  // so

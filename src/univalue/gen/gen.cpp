...
static void initJsonEscape() {
  // Escape all lower control characters (some get overridden with smaller
  // sequences below)
...
static void outputEscape() {
  printf("// Automatically generated file. Do not modify.\n"
         "#ifndef JFKBITCOIN1776_UNIVALUE_UNIVALUE_ESCAPES_H\n"
         "#define JFKBITCOIN1776_UNIVALUE_UNIVALUE_ESCAPES_H\n"
  ...
  printf("};\n"
         "#endif // JFKBITCOIN1776_UNIVALUE_UNIVALUE_ESCAPES_H\n");
}

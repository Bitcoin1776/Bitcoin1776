...
Also test that nodes that send unsupported service bits to jfkbitcoin1776d are disconnected
...
class CNodeNoVersionBan(CLazyNode):
    ...
    # NOTE: implementation-specific check here. Remove if jfkbitcoin1776d ban behavior changes
    def on_open(self, conn):
        super().on_open(conn)
...
class P2PLeakTest(JFKBitcoin1776TestFramework):

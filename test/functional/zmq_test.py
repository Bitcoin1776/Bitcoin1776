...
from test_framework.test_framework import JFKBitcoin1776TestFramework, SkipTest
from test_framework.util import (assert_equal,
                                 bytes_to_hex_str,
                                 hash256,
                                )

class ZMQTest (JFKBitcoin1776TestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that jfkbitcoin1776 has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("jfkbitcoin1776d has not been built with zmq enabled.")

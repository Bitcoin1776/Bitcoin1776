...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the JFKBitcoin1776TestFramework
    pass

class ExampleTest(JFKBitcoin1776TestFramework):
    # Each functional test is a subclass of the JFKBitcoin1776TestFramework class.
    ...
    def custom_method(self):
        ...
        JFKBitcoin1776TestFramework class so other tests can use it."""

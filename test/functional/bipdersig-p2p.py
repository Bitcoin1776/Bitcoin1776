...
class BIP66Test(JFKBitcoin1776TestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # jfkbitcoin1776d is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and jfkbitcoin1776d produces more specific reject
            # reasons.

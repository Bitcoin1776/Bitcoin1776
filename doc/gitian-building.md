...
*Setup instructions for a Gitian build of JFKBitcoin1776 Core using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the JFKBitcoin1776
...
- [Building JFKBitcoin1776 Core](#building-jfkbitcoin1776-core)
...
- [LXC](https://linuxcontainers.org/), see also [Gitian host docker container](https://github.com/gdm85/tenku/tree/master/docker/gitian-jfkbitcoin1776-host/README.md).
...
Clone the git repositories for jfkbitcoin1776 and Gitian.
...
in the jfkbitcoin1776 repository under 'Fetch and create inputs' to install sources which require
manual intervention. Also optionally follow the next step: 'Seed the Gitian sources cache
and offline git repositories' which will fetch the remaining files required for building
offline.

Building JFKBitcoin1776 Core
----------------

To build JFKBitcoin1776 Core (for Linux, OS X and Windows) just follow the steps under 'perform
Gitian builds' in [doc/release-process.md](release-process.md#perform-gitian-builds) in the jfkbitcoin1776 repository.
...
Output from `gbuild` will look something like
    ...
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/jfkbitcoin1776/.git/
    remote: Counting objects: 57959, done.
    remote: Total 57959 (delta 0), reused 0 (delta 0), pack-reused 57958
    Receiving objects: 100% (57959/57959), 53.76 MiB | 484.00 KiB/s, done.
    Resolving deltas: 100% (41590/41590), done.
    From https://github.com/jfkbitcoin1776/jfkbitcoin1776
...
For example:
```bash
URL=https://github.com/laanwj/jfkbitcoin1776.git
COMMIT=2014_03_windows_unicode_path
./bin/gbuild --commit jfkbitcoin1776=${COMMIT} --url jfkbitcoin1776=${URL} ../jfkbitcoin1776/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit jfkbitcoin1776=${COMMIT} --url jfkbitcoin1776=${URL} ../jfkbitcoin1776/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit jfkbitcoin1776=${COMMIT} --url jfkbitcoin1776=${URL} ../jfkbitcoin1776/contrib/gitian-descriptors/gitian-osx.yml
```
...
and the jfkbitcoin1776 git repository with the desired tag must both be available locally, and then gbuild must be
...
LXC_ARCH=amd64 LXC_SUITE=trusty on-target -u root \
  ...
  $( sed -ne '/^packages:/,/[^-] .*/ {/^- .*/{s/"//g;s/- //;p}}' ../jfkbitcoin1776/contrib/gitian-descriptors/*|sort|uniq )
...
JFKPATH=/some/root/path/jfkbitcoin1776
SIGPATH=/some/root/path/jfkbitcoin1776-detached-sigs

./bin/gbuild --url jfkbitcoin1776=${JFKPATH},signature=${SIGPATH} ../jfkbitcoin1776/contrib/gitian-descriptors/gitian-win-signer.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/jfkbitcoin1776-linux-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/jfkbitcoin1776-win-build.assert
    gpg --detach-sign ${VERSION}-osx-unsigned/${SIGNER}/jfkbitcoin1776-osx-build.assert
```
...
[jfkbitcoin1776-core/gitian.sigs](https://github.com/jfkbitcoin1776-core/gitian.sigs/) repository, or if that's not possible create a pull

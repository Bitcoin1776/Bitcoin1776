...
This document provides guidelines for internationalization of the JFKBitcoin1776 Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `jfkbitcoin1776_en.ts` remains unchanged.

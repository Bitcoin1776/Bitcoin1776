JFKBitcoin1776 Core version 0.13.2 is now available from:

  <https://jfkbitcoin1776.org/bin/jfkbitcoin1776-core-0.13.2/>
...
- #8908 `4a974b2` Update jfkbitcoin1776-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow jfkbitcoin1776-tx to create v2 transactions (btcdrak)

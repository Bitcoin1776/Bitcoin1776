JFKBitcoin1776 Core version 0.9.4 is now available from:

  https://jfkbitcoin1776.org/bin/0.9.4/
...
this update is incompatible with the JFKBitcoin1776 system and could lead to consensus
forks.

JFKBitcoin1776 Core released binaries from https://jfkbitcoin1776.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~jfkbitcoin1776/+archive/ubuntu/jfkbitcoin1776
- A third-party or self-compiled JFKBitcoin1776 Core

upgrade to JFKBitcoin1776 Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.

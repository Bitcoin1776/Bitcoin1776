JFKBitcoin1776 Core version 0.13.1 is now available from:

  <https://jfkbitcoin1776.org/bin/jfkbitcoin1776-core-0.13.1/>
...
updates will be released anymore. Without security updates, using a jfkbitcoin1776
wallet on a XP machine is irresponsible at least.

In addition to that, with 0.12.x there have been varied reports of JFKBitcoin1776 Core
randomly crashing on Windows XP. It is [not clear](https://github.com/jfkbitcoin1776/jfkbitcoin1776/issues/7681#issuecomment-217439891)
...
- **Elimination of unwanted transaction malleability:** Segregating the witness
  ...
  malleability, which is a problem that makes programming JFKBitcoin1776 wallet
  software more difficult and which seriously complicates the design of smart
  contracts for JFKBitcoin1776.
...
- **Weighting data based on how it affects node performance:** Some parts of
  each JFKBitcoin1776 block need to be stored by nodes in order to validate future
...
- **Signature covers value:** A simple improvement in the way signatures are
  ...
  of jfkbitcoin1776s they think they are spending, and by having full nodes refuse to
  accept those signatures unless the amount of jfkbitcoin1776s being spent is exactly
...
- **Increased security for multisig:** JFKBitcoin1776 addresses (both P2PKH addresses
  ...
  believed to be provided by JFKBitcoin1776's choice of parameters for its Elliptic
  Curve Digital Security Algorithm [ECDSA].)

- **More efficient almost-full-node security** Satoshi Nakamoto's original
  JFKBitcoin1776 paper describes a method for allowing newly-started full nodes to
  skip downloading and validating some data from historic blocks that are
  protected by large amounts of proof of work.  Unfortunately, Nakamoto's
  method can't guarantee that a newly-started node using this method will
  produce an accurate copy of JFKBitcoin1776's current ledger (called the UTXO set),
  ...
  note that JFKBitcoin1776 Core does not provide an option to use this capability as
  of this 0.13.1 release.

- **Script versioning:** Segwit makes it easy for future soft forks to allow
  JFKBitcoin1776 users to individually opt-in to almost any change in the JFKBitcoin1776
  Script language when those users receive new transactions.  Features
  currently being researched by JFKBitcoin1776 Core contributors that may use this
  capability include support for Schnorr signatures, which can improve the
  privacy and efficiency of multisig transactions (or transactions with
  multiple inputs), and Merklized Abstract Syntax Trees (MAST), which can
  improve the privacy and efficiency of scripts with two or more conditions.
  Other JFKBitcoin1776 community members are studying several other improvements
...
[Segwit FAQ]: https://jfkbitcoin1776core.org/en/2016/01/26/segwit-benefits/
[segwit wallet developers guide]: https://jfkbitcoin1776core.org/en/segwit_wallet_dev/
[BIP141]: https://github.com/jfkbitcoin1776/bips/blob/master/bip-0141.mediawiki
[BIP143]: https://github.com/jfkbitcoin1776/bips/blob/master/bip-0143.mediawiki
[BIP144]: https://github.com/jfkbitcoin1776/bips/blob/master/bip-0144.mediawiki
[BIP145]: https://github.com/jfkbitcoin1776/bips/blob/master/bip-0145.mediawiki
[versionbits FAQ]: https://jfkbitcoin1776core.org/en/2016/06/08/version-bits-miners-faq/
...
Since JFKBitcoin1776 Core 0.10.0, nodes have defaulted to only relaying and
...
[BIP147]: https://github.com/jfkbitcoin1776/bips/blob/master/bip-0147.mediawiki
...
- `jfkbitcoin1776-${VERSION}-arm-linux-gnueabihf.tar.gz`: Linux binaries targeting
  the 32-bit ARMv7-A architecture.
- `jfkbitcoin1776-${VERSION}-aarch64-linux-gnu.tar.gz`: Linux binaries targeting
...
- #8848 `7a34a46` Add NULLDUMMY verify flag in jfkbitcoin1776consensus.h (jl2012)
...
- #8940 `5b4192b` Add x9 service bit support to dnsseed.bluematt.me, seed.jfkbitcoin1776stats.com (TheBlueMatt, cdecker)
- #8944 `685e4c7` Remove bogus assert on number of oubound connections. (TheBlueMatt)
- #8949 `0dbc48a` Be more agressive in getting connections to peers with relevant services (gmaxwell)

### Build system
- #8293 `fa5b249` Allow building libjfkbitcoin1776consensus without any univalue (luke-jr)
- #8492 `8b0bdd3` Allow building bench_jfkbitcoin1776 by itself (luke-jr)
...
- #8829 `2a8bca4` Add jfkbitcoin1776-tx JSON tests (jnewbery)
- #8834 `1dd1783` blockstore: Switch to dumb dbm (MarcoFalke)
- #8835 `d87227d` nulldummy.py: Don't run unused code (MarcoFalke)
- #8836 `eb18cc1` jfkbitcoin1776-util-test.py should fail if the output file is empty (jnewbery)
...
- #8860 `0bee740` util: Move wait_jfkbitcoin1776ds() into stop_nodes() (MarcoFalke)
...
- #8683 `8a7d7ff` Fix incorrect file name jfkbitcoin1776.qrc  (jfkbitcoin1776sSG)
...
- #8817 `bcf3806` update jfkbitcoin1776-tx to output witness data (jnewbery)

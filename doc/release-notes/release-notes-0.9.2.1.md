JFKBitcoin1776 Core version 0.9.2.1 is now available from:

  https://jfkbitcoin1776.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 JFK to 0.01 JFK
...
- Fix "Start jfkbitcoin1776 on system login"

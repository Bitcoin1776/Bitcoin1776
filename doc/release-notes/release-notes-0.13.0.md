JFKBitcoin1776 Core version 0.13.0 is now available from:

  <https://jfkbitcoin1776.org/bin/jfkbitcoin1776-core-0.13.0/>
...
- Adding `dbcache=100` in jfkbitcoin1776.conf
...
jfkbitcoin1776-cli: arguments privacy
------------------------------
...
For example:
    ...
    $ src/jfkbitcoin1776-cli -stdin walletpassphrase
    mysecretcode
    120
...
Various code modernizations have been done. The JFKBitcoin1776 Core code base has
...
compatible peers.
[BIP 152](https://github.com/jfkbitcoin1776/bips/blob/master/bip-0152.mediawiki)
...
HD wallets are incompatible with older versions of JFKBitcoin1776 Core.

[Pull request](https://github.com/jfkbitcoin1776/jfkbitcoin1776/pull/8035/files), [BIP 32](https://github.com/jfkbitcoin1776/bips/blob/master/bip-0032.mediawiki)
...
141](https://github.com/jfkbitcoin1776/bips/blob/master/bip-0141.mediawiki), [BIP
143](https://github.com/jfkbitcoin1776/bips/blob/master/bip-0143.mediawiki), [BIP
144](https://github.com/jfkbitcoin1776/bips/blob/master/bip-0144.mediawiki), and [BIP
145](https://github.com/jfkbitcoin1776/bips/blob/master/bip-0145.mediawiki) are
finished and included in this release.  However, BIP 141 does not yet specify
activation parameters on mainnet, and so this release does not support segwit
use on mainnet.  Testnet use is supported, and after BIP 141 is updated with
proposed parameters, a future release of JFKBitcoin1776 Core is expected that
...
Witness)] (https://github.com/jfkbitcoin1776/bips/blob/master/bip-0141.mediawiki).
...
(https://github.com/jfkbitcoin1776/bips/blob/master/bip-0141.mediawiki) for additional
details.)
...
The two phases are distinct in the JFKBitcoin1776-Qt GUI. During the first one,
...
- The optional new p2p message "feefilter" is implemented and the protocol
  ...
  feerate. [BIP 133](https://github.com/jfkbitcoin1776/bips/blob/master/bip-0133.mediawiki)
...
65](https://github.com/jfkbitcoin1776/bips/blob/master/bip-0065.mediawiki)

  - OP_NOP3 has been renamed to OP_CHECKSEQUENCEVERIFY by [BIP 
112](https://github.com/jfkbitcoin1776/bips/blob/master/bip-0112.mediawiki)
...
- Each ZMQ notification now contains an up-counting sequence number that allows
  ...
  PR [#7762](https://github.com/jfkbitcoin1776/jfkbitcoin1776/pull/7762).
...
- #7550 `8b958ab` Input-from-stdin mode for jfkbitcoin1776-cli (laanwj)
...
- #8153 `75ec320` `fundrawtransaction` feeRate: Use JFK/kB (MarcoFalke)
...
- #7613 `3798e5d` Add autocomplete to jfkbitcoin1776-qt's console window (GamerSg)
...
- #7636 `fb0ac48` Add jfkbitcoin1776 address label to request payment QR code (makevoid)
- #8231 `760a6c7` Fix a bug where the SplashScreen will not be hidden during startup (jonasschnelli)
- #8256 `af2421c` BUG: jfkbitcoin1776-qt crash (fsb4000)
- #8257 `ff03c50` Do not ask a UI question from jfkbitcoin1776d (sipa)
- #8288 `91abb77` Network-specific example address (laanwj)
- #7707 `a914968` UI support for abandoned transactions (jonasschnelli)
- #8207 `f7a403b` Add a link to the JFKBitcoin1776-Core repository and website to the About Dialog (MarcoFalke)
...
- #8047 `37f9a1f` Test_framework: Set wait-timeout for jfkbitcoin1776d procs (MarcoFalke)
...
- #8164 `0f24eaf` [JFKBitcoin1776-Tx] fix missing test fixtures, fix 32bit atoi issue (jonasschnelli)
...
- #7744 `d8e862a` test_framework: detect failure of jfkbitcoin1776d startup (laanwj)
...
- #7975 `fc23fee` Update jfkbitcoin1776-core GitHub links (MarcoFalke)

JFKBitcoin1776 Core version 0.14.2 is now available from:

  <https://jfkbitcoin1776.org/bin/jfkbitcoin1776-core-0.14.2/>
...
(in JFKBitcoin1776 Core 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in JFKBitcoin1776-Qt when using coin
...
- #10228 `ae479bc` Regenerate jfkbitcoin1776-config.h as necessary (theuni)

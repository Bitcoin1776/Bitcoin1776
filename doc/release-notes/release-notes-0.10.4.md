JFKBitcoin1776 Core version 0.10.4 is now available from:

  <https://jfkbitcoin1776.org/bin/jfkbitcoin1776-core-0.10.4/>
...
- #6953 `43c2789` Split jfkbitcoin1776-tx into its own package
- #6953 `dfe0d4d` Include jfkbitcoin1776-tx binary on Debian/Ubuntu

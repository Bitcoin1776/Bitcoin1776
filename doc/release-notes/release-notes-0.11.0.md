JFKBitcoin1776 Core version 0.11.0 is now available from:

  <https://jfkbitcoin1776.org/bin/jfkbitcoin1776-core-0.11.0/>
...
defaults to 0.00001. This will cause transactions with fewer JFK/kB fee to be
...
For example, add the following to `jfkbitcoin1776.conf`:
...
related to the blockchain in the jfkbitcoin1776 system: the raw blocks as received over 
the network (blk???.dat), the undo data (rev???.dat), the block index and the 
UTXO set (both LevelDB databases). The databases are built from the raw data.

Block pruning allows JFKBitcoin1776 Core to delete the raw block and undo data once 
...
block index and UTXO databases. The minimum was chosen so that JFKBitcoin1776 Core will 
...
For an example script see [jfkbitcoin1776-submittx](https://github.com/laanwj/jfkbitcoin1776-submittx).
...
- #5334 `cf87536` libjfkbitcoin1776consensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new jfkbitcoin1776-detached-sigs git repo for OSX signatures
...
- #5729 `9c4a5a5` Allow unit changes for read-only JFKBitcoin1776AmountField
- #5753 `0f44672` Add jfkbitcoin1776 logo to about screen
...
- #5809 `46bfbe7` Add jfkbitcoin1776-cli man page
...
- #5849 `41259ca` contrib/init/jfkbitcoin1776d.openrc: Compatibility with previous OpenRC init script variables
...
- #6116 `30dc3c1` [OSX] rename JFKBitcoin1776-Qt.app to JFKBitcoin1776-Core.app
- #6168 `b3024f0` contrib/linearize: Support linearization of testnet blocks
- #6098 `7708fcd` Update Windows resource files (and add one for jfkbitcoin1776-tx)

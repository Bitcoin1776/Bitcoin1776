JFKBitcoin1776 version 0.7.2 is now available from:
  http://sourceforge.net/projects/jfkbitcoin1776/files/JFKBitcoin1776/jfkbitcoin1776-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused JFKBitcoin1776-Qt to crash on Windows when exiting.
